...
@argument/Number|String code
    @optional
    @default "303 See Other"
    Use a particular redirect code.
...
*/
Reply.prototype.redirect = function (code, targetURL) {
    if (arguments.length < 2) {
        targetURL = code;
        code = 303;
    }
    if (!targetURL)
        throw new Error ('must provide a targetURL when calling Reply#redirect');
